...
const LinkProject = [
  ...
  { name: 'Javascript 計算機', link: '/hexschool/js-clock/index.html', state: "new", tool: 'JavaScript' },
  { name: 'Javascript 時區', link: '/hexschool/js-clock/index.html', state: "pending", tool: 'JavaScript' },
